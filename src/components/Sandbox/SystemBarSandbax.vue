  ...
  <v-row justify="center" align="center">
    <v-container fluid>
      <v-card img="https://cdn.vuetifyjs.com/images/home/vuetify_layout1.svg" height="200px" class="mb-6">
        <v-system-bar color="orange" :height="height" :lights-out="lightsOut" :window="window">
    ...
    <v-row>
      <v-col cols="4">
        <v-text-field v-model="height" class="mx-4" label="Height - px" max="30" min="1" step="1" style="width: 125px" type="number" @keydown="false"></v-text-field>
      </v-col>
      <v-col cols="4">
