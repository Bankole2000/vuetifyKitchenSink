<template>
  <v-container>
    ...
    <v-card class="mx-auto my-6" outlined elevation="0">
      <v-card-title class=" grey lighten-4">
        ...
        <v-tooltip bottom>
          <template v-slot:activator="{ on, attrs }">
            <v-btn
              @click="elevateOnScroll.showCode = !elevateOnScroll.showCode"
              text
              class="text--primary"
              v-bind="attrs"
              v-on="on"
      ...
      <v-expand-transition>
        <v-sheet v-if="elevateOnScroll.showCode" tile>
          <v-card-title tile class="py-2 grey darken-3">
            <v-btn text class="white--text" rounded @click="window = 0"
              >Template</v-btn
            >
            ...
            <v-tooltip bottom>
              <template v-slot:activator="{ on, attrs }">
                <v-btn
                  ...
                  v-on="on"
                  @mouseleave="tooltipText = 'Copy Code'"
                  @click="copy(elevateOnScroll.template)"
                >
                  <v-icon>mdi-content-copy</v-icon>
                </v-btn>
              </template>
    ...
    <v-card class="mx-auto my-6" outlined elevation="0">
      <v-card-title class=" grey lighten-4">
        ...
        <v-tooltip bottom>
          <template v-slot:activator="{ on, attrs }">
            <v-btn
              @click="hideOnScroll.showCode = !hideOnScroll.showCode"
              text
              class="text--primary"
              v-bind="attrs"
              v-on="on"
      ...
      <v-expand-transition>
        <v-sheet v-if="hideOnScroll.showCode" tile>
          <v-card-title tile class="py-2 grey darken-3">
            <v-btn text class="white--text" rounded @click="window = 0"
              >Template</v-btn
            >
            ...
            <v-tooltip bottom>
              <template v-slot:activator="{ on, attrs }">
                <v-btn
                  ...
                  v-on="on"
                  @mouseleave="tooltipText = 'Copy Code'"
                  @click="copy(hideOnScroll.template)"
                >
                  <v-icon>mdi-content-copy</v-icon>
                </v-btn>
              </template>
    ...
    <v-card class="mx-auto my-6" outlined elevation="0">
      <v-card-title class=" grey lighten-4">
        ...
        <v-tooltip bottom>
          <template v-slot:activator="{ on, attrs }">
            <v-btn
              @click="invertedScrolling.showCode = !invertedScrolling.showCode"
              text
              class="text--primary"
              v-bind="attrs"
              v-on="on"
      ...
      <v-expand-transition>
        <v-sheet v-if="invertedScrolling.showCode" tile>
          <v-card-title tile class="py-2 grey darken-3">
            <v-btn text class="white--text" rounded @click="window = 0"
              >Template</v-btn
            >
            ...
            <v-tooltip bottom>
              <template v-slot:activator="{ on, attrs }">
                <v-btn
                  ...
                  v-on="on"
                  @mouseleave="tooltipText = 'Copy Code'"
                  @click="copy(invertedScrolling.template)"
                >
                  <v-icon>mdi-content-copy</v-icon>
                </v-btn>
              </template>
    ...
    <v-card class="mx-auto my-6" outlined elevation="0">
      <v-card-title class=" grey lighten-4">
        Prominent With Scroll Shrink
        <v-spacer></v-spacer>
        <v-tooltip bottom>
          <template v-slot:activator="{ on, attrs }">
            <v-btn
              @click="
                prominentWithScrollShrink.showCode = !prominentWithScrollShrink.showCode
              "
              text
              class="text--primary"
              v-bind="attrs"
      ...
      <v-expand-transition>
        <v-sheet v-if="prominentWithScrollShrink.showCode" tile>
          <v-card-title tile class="py-2 grey darken-3">
            <v-btn text class="white--text" rounded @click="window = 0"
              >Template</v-btn
            >
            ...
            <v-tooltip bottom>
              <template v-slot:activator="{ on, attrs }">
                <v-btn
                  ...
                  v-on="on"
                  @mouseleave="tooltipText = 'Copy Code'"
                  @click="copy(prominentWithScrollShrink.template)"
                >
                  <v-icon>mdi-content-copy</v-icon>
                </v-btn>
              </template>
          ...
          >
            <v-window>
              <v-window-item>
                <prism language="html" class="py-3 my-0">{{
                  prominentWithScrollShrink.template
                }}</prism>
              </v-window-item>
            </v-window>
          </v-card>
      ...
      <v-container>
        <ProminentWithScrollShrink />
      </v-container>
    </v-card>

    <v-card class="mx-auto my-6" outlined elevation="0">
      <v-card-title class=" grey lighten-4">
        Prominent with Shrink and Image
        <v-spacer></v-spacer>
        <v-tooltip bottom>
          <template v-slot:activator="{ on, attrs }">
            <v-btn
              @click="
                prominentWithScrollShrinkAndImage.showCode = !prominentWithScrollShrinkAndImage.showCode
              "
              text
              class="text--primary"
              v-bind="attrs"
      ...
      <v-expand-transition>
        <v-sheet v-if="prominentWithScrollShrinkAndImage.showCode" tile>
          <v-card-title tile class="py-2 grey darken-3">
            <v-btn text class="white--text" rounded @click="window = 0"
              >Template</v-btn
            >
            ...
            <v-tooltip bottom>
              <template v-slot:activator="{ on, attrs }">
                <v-btn
                  ...
                  v-on="on"
                  @mouseleave="tooltipText = 'Copy Code'"
                  @click="copy(prominentWithScrollShrinkAndImage.template)"
                >
                  <v-icon>mdi-content-copy</v-icon>
                </v-btn>
              </template>
          ...
          >
            <v-window>
              <v-window-item>
                <prism language="html" class="py-3 my-0">{{
                  prominentWithScrollShrinkAndImage.template
                }}</prism>
              </v-window-item>
            </v-window>
          </v-card>
      ...
      <v-container>
        <ProminentWithScrollShrinkAndImage />
      </v-container>
    </v-card>

    <v-card class="mx-auto my-6" outlined elevation="0">
      <v-card-title class=" grey lighten-4">
        Prominent with Shrink and Image Fade on Scroll
        <v-spacer></v-spacer>
        <v-tooltip bottom>
          <template v-slot:activator="{ on, attrs }">
            <v-btn
              @click="
                prominentWithScrollShrinkAndImageFadeOnScroll.showCode = !prominentWithScrollShrinkAndImageFadeOnScroll.showCode
              "
              text
              class="text--primary"
              v-bind="attrs"
      ...
      <v-expand-transition>
        <v-sheet
          v-if="prominentWithScrollShrinkAndImageFadeOnScroll.showCode"
          tile
        >
          <v-card-title tile class="py-2 grey darken-3">
            <v-btn text class="white--text" rounded @click="window = 0"
            ...
            <v-tooltip bottom>
              <template v-slot:activator="{ on, attrs }">
                <v-btn
                  ...
                  @mouseleave="tooltipText = 'Copy Code'"
                  @click="
                    copy(prominentWithScrollShrinkAndImageFadeOnScroll.template)
                  "
                >
                  <v-icon>mdi-content-copy</v-icon>
                </v-btn>
          ...
          >
            <v-window>
              <v-window-item>
                <prism language="html" class="py-3 my-0">{{
                  prominentWithScrollShrinkAndImageFadeOnScroll.template
                }}</prism>
              </v-window-item>
            </v-window>
          </v-card>
      ...
      <v-container>
        <ProminentWithScrollShrinkAndImageFadeOnScroll />
      </v-container>
    </v-card>
    ...
    <v-card class="mx-auto my-6" outlined elevation="0">
      <v-card-title class=" grey lighten-4">
        ...
        <v-tooltip bottom>
          <template v-slot:activator="{ on, attrs }">
            <v-btn
              @click="scrollThreshold.showCode = !scrollThreshold.showCode"
              text
              class="text--primary"
              v-bind="attrs"
              v-on="on"
      ...
      <v-expand-transition>
        <v-sheet v-if="scrollThreshold.showCode" tile>
          <v-card-title tile class="py-2 grey darken-3">
            <v-btn text class="white--text" rounded @click="window = 0"
              >Template</v-btn
            >
            ...
            <v-tooltip bottom>
              <template v-slot:activator="{ on, attrs }">
                <v-btn
                  ...
                  v-on="on"
                  @mouseleave="tooltipText = 'Copy Code'"
                  @click="copy(scrollThreshold.template)"
                >
                  <v-icon>mdi-content-copy</v-icon>
                </v-btn>
              </template>
    ...
    <v-card class="mx-auto my-6" outlined elevation="0">
      <v-card-title class=" grey lighten-4">
        ...
        <v-tooltip bottom>
          <template v-slot:activator="{ on, attrs }">
            <v-btn
              @click="toggleNavDrawers.showCode = !toggleNavDrawers.showCode"
              text
              class="text--primary"
              v-bind="attrs"
              v-on="on"
      ...
      <v-expand-transition>
        <v-sheet v-if="toggleNavDrawers.showCode" tile>
          <v-card-title tile class="py-2 grey darken-3">
            <v-btn
              text
              class="white--text"
              rounded
              @click="toggleNavDrawers.window = 0"
              >Template</v-btn
            >
            <v-btn
              text
              class="white--text"
              rounded
              @click="toggleNavDrawers.window = 1"
              >Script</v-btn
            >
            <v-spacer></v-spacer>
            <v-tooltip bottom
              ><template v-slot:activator="{ on, attrs }">
                <v-btn
                  ...
                  @mouseleave="tooltipText = 'Copy Code'"
                  @click="
                    copy(toggleNavDrawers.template + toggleNavDrawers.script)
                  "
                >
                  <v-icon>mdi-content-copy</v-icon>
                </v-btn>
          ...
          <v-card
            ...
            style="overflow-y: scroll; overflow-x:auto;"
          >
            <v-window v-model="toggleNavDrawers.window">
              <v-window-item>
                <prism language="html" class="py-3 my-0">{{
                  toggleNavDrawers.template
                }}</prism>
              </v-window-item>
              <v-window-item>
                <prism language="js" class="py-3 my-0">{{
                  toggleNavDrawers.script
                }}</prism>
              </v-window-item>
            </v-window>
          </v-card>
    ...
    <v-card class="mx-auto my-6" outlined elevation="0">
      <v-card-title class=" grey lighten-4">
        ...
        <v-tooltip bottom>
          <template v-slot:activator="{ on, attrs }">
            <v-btn
              @click="collapsible.showCode = !collapsible.showCode"
              text
              class="text--primary"
              v-bind="attrs"
              v-on="on"
      ...
      <v-expand-transition>
        <v-sheet v-if="collapsible.showCode" tile>
          <v-card-title tile class="py-2 grey darken-3">
            <v-btn
              text
              class="white--text"
              rounded
              @click="collapsible.window = 0"
              >Template</v-btn
            >
            <v-btn
              text
            ...
            <v-tooltip bottom
              ><template v-slot:activator="{ on, attrs }">
                <v-btn
                  ...
                  v-on="on"
                  @mouseleave="tooltipText = 'Copy Code'"
                  @click="copy(collapsible.template + collapsible.script)"
                >
                  <v-icon>mdi-content-copy</v-icon>
                </v-btn>
              </template>
          ...
          <v-card
            ...
            style="overflow-y: scroll; overflow-x:auto;"
          >
            <v-window v-model="collapsible.window">
              <v-window-item>
                <prism language="html" class="py-3 my-0">{{
...
`,
      ...
      collapsible: {
        template: `<template>
  <v-card class="overflow-hidden">
    <v-app-bar :collapse="!collapseOnScroll" :collapse-on-scroll="collapseOnScroll" absolute color="deep-purple accent-4" dark scroll-target="#scrolling-techniques-6">
      <v-app-bar-nav-icon></v-app-bar-nav-icon>
