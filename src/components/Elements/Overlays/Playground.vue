  ...
  <v-row justify="center">
    ...
    <v-row justify="center">
      <v-radio-group row>
        ...
        <v-text-field v-model="opacity" label="Opacity" max="1" min="0" step=".01" style="width: 125px" type="number" @keydown="false"></v-text-field>
        <v-text-field v-model="zIndex" label="z-index" max="9999" min="-9999" step="1" style="width: 125px" type="number" @keydown="false"></v-text-field>
      </v-radio-group>
    </v-row>
  </v-row>
</template>
