    ...
    <v-responsive :max-width="type.indexOf('table') > -1 ? 900 : 500" class="mx-auto">
      <v-responsive class="mx-auto mb-12" max-width="500">
        <div class="d-flex pa-3 align-center flex-wrap">
          <v-select v-model="type" :items="types" class="mr-12" hide-details label="Pre-made Types" filled style="max-width: 250px;"></v-select>
      ...
      <v-skeleton-loader ref="skeleton" :boilerplate="boilerplate" :type="type" :tile="tile" class="mx-auto"></v-skeleton-loader>
    </v-responsive>
  </v-sheet>
</template>
