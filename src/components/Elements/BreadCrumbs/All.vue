<template>
  <v-container>
    ...
    <v-card class="mx-auto my-6" outlined elevation="0">
      <v-card-title class=" grey lighten-4">
        Breadcrumb - Custom Dividers
        <v-spacer></v-spacer>
        <v-tooltip bottom>
          <template v-slot:activator="{ on, attrs }">
            <v-btn
              @click="customDivider.showCode = !customDivider.showCode"
              text
              class="text--primary"
              v-bind="attrs"
              v-on="on"
      ...
      <v-expand-transition>
        <v-sheet v-if="customDivider.showCode" tile>
          <v-card-title tile class="py-2 grey darken-3">
            <v-btn
              text
              class="white--text"
              rounded
              @click="customDivider.window = 0"
              >Template</v-btn
            >
            <v-btn
              text
            ...
            <v-tooltip bottom
              ><template v-slot:activator="{ on, attrs }">
                <v-btn
                  ...
                  v-on="on"
                  @mouseleave="tooltipText = 'Copy Code'"
                  @click="copy(customDivider.template + customDivider.script)"
                >
                  <v-icon>mdi-content-copy</v-icon>
                </v-btn>
              </template>
          ...
          <v-card
            ...
            style="overflow-y: scroll; overflow-x:auto;"
          >
            <v-window v-model="customDivider.window">
              <v-window-item>
                <prism language="html" class="py-3 my-0">{{
                  customDivider.template
                }}</prism>
              </v-window-item>
              <v-window-item>
                <prism language="js" class="py-3 my-0">{{
                  customDivider.script
                }}</prism>
              </v-window-item>
            </v-window>
          </v-card>
    ...
    <v-card class="mx-auto my-6" outlined elevation="0">
      <v-card-title class=" grey lighten-4">
        Breadcrumbs - Item Slots
        <v-spacer></v-spacer>
        <v-tooltip bottom>
          <template v-slot:activator="{ on, attrs }">
            <v-btn
              @click="itemSlot.showCode = !itemSlot.showCode"
              text
              class="text--primary"
              v-bind="attrs"
              v-on="on"
      ...
      <v-expand-transition>
        <v-sheet v-if="itemSlot.showCode" tile>
          <v-card-title tile class="py-2 grey darken-3">
            <v-btn text class="white--text" rounded @click="itemSlot.window = 0"
              >Template</v-btn
            >
            <v-btn text class="white--text" rounded @click="itemSlot.window = 1"
              >Script</v-btn
            >
            <v-spacer></v-spacer>
            <v-tooltip bottom
              ><template v-slot:activator="{ on, attrs }">
                <v-btn
                  ...
                  v-on="on"
                  @mouseleave="tooltipText = 'Copy Code'"
                  @click="copy(itemSlot.template + itemSlot.script)"
                >
                  <v-icon>mdi-content-copy</v-icon>
                </v-btn>
              </template>
          ...
          <v-card
            ...
            style="overflow-y: scroll; overflow-x:auto;"
          >
            <v-window v-model="itemSlot.window">
              <v-window-item>
                <prism language="html" class="py-3 my-0">{{
                  itemSlot.template
                }}</prism>
    ...
    <v-card class="mx-auto my-6" outlined elevation="0">
      <v-card-title class=" grey lighten-4">
        ...
        <v-tooltip bottom>
          <template v-slot:activator="{ on, attrs }">
            <v-btn
              @click="large.showCode = !large.showCode"
              text
              class="text--primary"
              v-bind="attrs"
              v-on="on"
      ...
      <v-expand-transition>
        <v-sheet v-if="large.showCode" tile>
          <v-card-title tile class="py-2 grey darken-3">
            <v-btn text class="white--text" rounded @click="large.window = 0"
              >Template</v-btn
            >
            <v-btn text class="white--text" rounded @click="large.window = 1"
              >Script</v-btn
            >
            <v-spacer></v-spacer>
            <v-tooltip bottom
              ><template v-slot:activator="{ on, attrs }">
                <v-btn
                  ...
                  v-on="on"
                  @mouseleave="tooltipText = 'Copy Code'"
                  @click="copy(large.template + large.script)"
                >
                  <v-icon>mdi-content-copy</v-icon>
                </v-btn>
              </template>
...
import IconDivider from './IconDividers';
