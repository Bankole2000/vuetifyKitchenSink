      ...
      <v-card-text>
        <p>
          ...
          <span class="text-decoration-underline">
            Use <code>updated</code> if you need to access the DOM after a
            property change:
          </span>
        </p>
...
export default {
  data() {
    return {
      ...
      examples: [
        {
          desc: `Checking the value of reactive data after rendering to the DOM`,
          code: `<template>
...
export default {
  ...
  updated() {
    ...
    console.log(this.counter);
        ...
        {
          desc: `<span class='success--text'>CAN</span> be used to access and alter the DOM`,
          code: `<template>
  <div ref="example-element">{{counter}}</div>
</template>
